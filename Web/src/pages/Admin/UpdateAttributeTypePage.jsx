  ...
  export default function UpdateAttributeTypePage() {
    ...
    const [id_mod, setId] = useState(id)
    const [description_mod, setDescription] = useState(description)
    ...
    function handleModAttributeType() {
      
      if(!id_mod.trim()){
        setError('El nombre del tipo de atributo es obligatorio.')
        return
      }
      if(!description_mod.trim()){
      ...
      setError(null)
      try {
        updateAttributeType(id,{
          id:id_mod.trim(),
          description:description_mod.trim()
        })
        ...
        <div className="flex min-h-[70vh] items-center justify-center px-6 ">
          <div className="w-full max-w-md">
            ...
            <label className="mb-1 block text-[11px] uppercase tracking-widest text-neutral-500">
              Nombre del Tipo Atributo Modificado
            </label>
            <input
              type="text"
              value={id_mod}
            ...
            <div className="flex items-center justify-between border-t border-neutral-800 pt-6">
                ...
                <button
                  type="button"
                  onClick={handleModAttributeType}
                  disabled={saving}
